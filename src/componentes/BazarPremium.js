...
function BazarPremium() {
	const url = 'https://cocinafacilconessenbuild.herokuapp.com/api/bazarpremium/'
	...
	return (			            
        <div className='body-b'>
            <img className='bannerproductos' src={BannerProductos} alt='Bazar premium Essen' width='100%'></img>
                ...
                <div className='row'>
                    <div className='col-3'>
                        ...
                        <div className="list-group">
                            ...
                            <a href="/productos/bazarpremium" className="list-group-item list-group-item-dark">Bazar Premium</a>
