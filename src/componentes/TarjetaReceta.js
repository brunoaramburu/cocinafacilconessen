...
const TarjetaReceta = () => {
  ...
  const obtenerReceta = async () => {
    const response = await fetch(`https://cocinafacilconessenbuild.herokuapp.com/api/receta/${nombre}/`)
  ...
  const obtenerOtrasRecetas = async () => {
    const response = await fetch('https://cocinafacilconessenbuild.herokuapp.com/api/receta/')
    const responseJSON = await response.json()
  ...
  const obtenerProductos = async () => {
    const response = await fetch('https://cocinafacilconessenbuild.herokuapp.com/api/producto/')
    const responseJSON = await response.json()
