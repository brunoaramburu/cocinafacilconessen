...
function ProductosCat() {
	const url = 'https://cocinafacilconessen.com.ar/api/productos/'
	...
	return (			            
        <div className='body-b'>
            <img className='bannerproductos' src={BannerProductos} alt='Productos Essen' width='100%'></img>
                ...
                <div className='row'>
                    <div className='col-3'>
                        ...
                        <div className="list-group">
                            <a href="/productos/productos" className="list-group-item list-group-item-dark">Productos</a>
